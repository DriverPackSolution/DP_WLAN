...
3. Run the command: "PnpUtil.exe -a {DriversDir}\*.INF", where {DriversDir} is the path where you put the drivers. (in our example: PnpUtil.exe -a C:\WiMAX_Drivers\*.INF)
